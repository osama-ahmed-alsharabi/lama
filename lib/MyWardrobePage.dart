...
class _WardrobeState extends State<Wardrobe> {
  ...
  void initState() {
    ...
    super.initState();
    tabItems = [];
    tabItems.add(TabBarItem(Icons.home, "", Categoryy()));
    tabItems.add(TabBarItem(Icons.camera_alt, "", TestColorNew()));
    tabItems.add(TabBarItem(Icons.checkroom, "", MyWardrobePage()));
  }
